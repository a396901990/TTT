...
public class MapUtil {
     ...
     * Google地图经纬度转百度地图经纬度
     * */
    public static Location google_bd_encrypt(double gg_lat, double gg_lon){
     ...
     * 百度转google
     * */
    public static Location bd_google_encrypt(double bd_lat, double bd_lon){
     ...
     * */
    public static Location wgs_gcj_encrypts(double wgLat, double wgLon) {
