...
import com.dean.travltotibet.adapter.MessageListAdapter;
 ...
 * 子类需要重写getUserMessage
 */
public abstract class UserMessageBaseFragment extends BaseRefreshFragment implements LoadMoreListView.OnLoadMoreListener {

    protected View root;
    protected MessageListAdapter mAdapter;
    protected ArrayList<UserMessage> userMessages;
    ...
    // 获取数据
    protected abstract void getUserMessage(final int actionType);
