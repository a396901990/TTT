...
public class StringUtil {
    ...
    public static String formatDouble(String format, final double argDouble) {
     ...
     * separator
     *
     * @param argArray      The array of objects to join
     * @param argSeparator  The character that will separate the joined elements
     * @param argStartIndex Where to start joining
     * @param argEndIndex   Where to end joining
     ...
     * @param sourceText   original text contains in the list
     * @param textWithLink text with 'href' link address
